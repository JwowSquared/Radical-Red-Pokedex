window.repo = "JwowSquared/Radical-Red-Pokedex"
...
document.querySelector("#capHardcoreCheckBox").checked = true
document.querySelector("#capOnlyNewCheckBox").checked = true
document.querySelector("#capEvolvedCheckBox").checked = true

let caps = []
let capidx = 0
let difficulty = document.querySelector("#capHardcoreCheckBox").checked ? "Hardcore" : "Normal"

let isFilteringByLevelCap = document.querySelector("#capFilterCheckBox").checked
let isFilteringByOnlyNew = document.querySelector("#capOnlyNewCheckBox").checked
let isFilteringByEvolved = document.querySelector("#capEvolvedCheckBox").checked
let isFilteringByLevelUp = document.querySelector("#capMovesCheckBox").checked

document.querySelector("#capCycleLeft").addEventListener("click", function() {
...
document.querySelector("#capCycleRight").addEventListener("click", function() {
...
document.querySelector("#capFilterCheckBox").addEventListener("change", function() {
	clearLevelCapFilter()
	isFilteringByLevelCap = this.checked
	showLevelCapFilter()
})

document.querySelector("#capHardcoreCheckBox").addEventListener("change", function() {
	clearLevelCapFilter()
	
	difficulty = this.checked ? "Hardcore" : "Normal"
	
	showLevelCapFilter()
})

document.querySelector("#capOnlyNewCheckBox").addEventListener("change", function() {
	clearLevelCapFilter()
	isFilteringByOnlyNew = this.checked
	showLevelCapFilter()
})

document.querySelector("#capEvolvedCheckBox").addEventListener("change", function() {
	clearLevelCapFilter()
	isFilteringByEvolved = this.checked
	showLevelCapFilter()
})

document.querySelector("#capMovesCheckBox").addEventListener("change", function() {
	isFilteringByLevelUp = this.checked
	
	recalculateMoveFilters()
})

let capDisplayText = document.getElementById("capDisplayText")
